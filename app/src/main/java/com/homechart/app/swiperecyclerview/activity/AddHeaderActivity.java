...
import com.homechart.app.swiperecyclerview.viewholder.AddHeaderViewHolder;
...
public class AddHeaderActivity
    ...
    private AddHeaderViewHolder mAddHeaderViewHolder;
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        mHeader = LayoutInflater.from(AddHeaderActivity.this).inflate(R.layout.header_add, null);
        mAddHeaderViewHolder = new AddHeaderViewHolder(mHeader);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mLoaderFlushAdapter = new LoaderFlushAdapter(R.layout.item_loader_flush, dataList);
        mLoaderFlushAdapter.addHeaderView(mHeader);
